...
lblInfo = Label(Tops, font=('arial', 20, 'bold'), text=localtime, fg="Steel Blue", bd=10, anchor='w').grid(row=1, column=0)
...
lblReference = Label(f1, font=('arial', 16, 'bold'), text="Name:", bd=16, anchor="w").grid(row=0, column=0)
...
# labels
lblMsg = Label(f1, font=('arial', 16, 'bold'), text="MESSAGE", bd=16, anchor="w").grid(row=1, column=0)
txtMsg = Entry(f1, font=('arial', 16, 'bold'), textvariable=Msg, bd=10, insertwidth=4, bg="powder blue", justify='right')

txtMsg.grid(row=1, column=1)

lblkey = Label(f1, font=('arial', 16, 'bold'), text="KEY", bd=16, anchor="w").grid(row=2, column=0)
txtkey = Entry(f1, font=('arial', 16, 'bold'), textvariable=key, bd=10, insertwidth=4,
               bg="powder blue", justify='right').grid(row=2, column=1)

lblmode = Label(f1, font=('arial', 16, 'bold'), text="MODE(e for encrypt, d for decrypt)",
...
lblService = Label(f1, font=('arial', 16, 'bold'), text="The Result-", bd=16, anchor="w").grid(row=2, column=2)
...
btnTotal = Button(f1, padx=16, pady=8, bd=16, fg="black", font=('arial', 16, 'bold'), width=10,
                  text="Show Message", bg="powder blue", command=Ref).grid(row=7, column=1)
